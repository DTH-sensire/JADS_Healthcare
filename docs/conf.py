...
# -*- coding: utf-8 -*-
#
# healthcare_jads documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'healthcare_jadsdoc'
...
texinfo_documents = [
    ('index', 'healthcare_jads', u'healthcare_jads Documentation',
     u"Dave Hamersma", 'healthcare_jads',
